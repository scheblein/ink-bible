...
Ink Bible is a community-driven, open-source project. Our goal is to provide a high-quality, open-source
...
Ink Bible thrives because people step up to build what they want to see.
- If you want a feature, the best way to get it is to start an
  [Idea Discussion](https://github.com/scheblein/ink-bible/discussions) or open a PR.
- If you want to report a bug, check for duplicates and create an
  [Issue](https://github.com/scheblein/ink-bible/issues).
